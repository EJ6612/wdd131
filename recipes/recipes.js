...
function search() {
	recipeQuery = document.querySelector('#searchInput').value;
	...
	let filteredRecipes = recipes.filter(function(recipe) {
		return (
			...
			recipe.recipeIngredient.find(ingredient => 
				ingredient.toLowerCase().includes(recipeQuery.toLowerCase()))
		);
	})
...
function recipeTemplate(recipe) {
	return `<article class="food-card">
            ...
            <div class="food-info">
                ...
                <p class="food-rating">${ratingTemplate(recipe.rating)}</p>
